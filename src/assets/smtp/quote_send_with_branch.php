...
if (isset($_POST["quantity"]) && !empty($_POST["quantity"]))
	{
	$quantity_value = "How many domain do you need to install: " . $_POST["quantity"] . "\n";
	}

if (isset($_POST["select_4"]) && !empty($_POST["select_4"]))
	{
	$select_value = "Why you don't need installation service? " . $_POST["select_4"] . "\n";
	}
...
4) Do you need installation service? $branchtype
$quantity_value
$select_value
...
// Enter the content of your reply message:
